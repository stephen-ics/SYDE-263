...
// Communication pins for Arduino1 (Master)
...
// Read the 2‑bit state coming from Arduino2.
int readTargetState() {
...
void setup() {
  ...
  Serial.println("Master Arduino Initialized");
  Serial.println("Waiting for current object state from Slave...");
}
